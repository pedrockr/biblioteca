                                ...
                                <form method="post" action="{{route('livro.update', $livro->id)}}">
                                    ...
                                    <div class="field is-horizontal">
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                <div class="control">
                                                    <label class="label is-large" for="nome_livros">Editar cadastro livros</label>
                                                </div>
                                                </div>
                                            </div>
                                        </div>                                  
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">                                    
                                        <input class="input" type="text" name="nome_livros" style="width: 40%" value="{{$livro->nome_livros}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">
                                            <input class="input" type="text" name="isbn_livros" style="width: 40%" value="{{$livro->isbn_livros}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">
                                            <input class="input" type="text" name="edicao_livros" style="width: 40%" value="{{$livro->edicao_livros}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">
                                            <input class="input" type="text" name="qtd_livros" style="width: 40%" value="{{$livro->qtd_livros}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">                              
                                            <input class = "input" list="fk_livros_autor" name="fk_livros_autor" style="width: 40%" value="{{$livro->fk_livros_autor}}">
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">  
                                            <input class = "input" list="fk_livros_editora" name="fk_livros_editora" style="width: 40%" value="{{$livro->fk_livros_editora}}">
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">
                                            <input class = "input" list="fk_livros_genero" name="fk_livros_genero" style="width: 40%" value="{{$livro->fk_livros_genero}}">
                                    ...
                                    <div class="field is-horizontal">
                                        ...
                                        <div class="field-body">                                            
                                            <input class = "input" list="fk_livros_prateleira" name="fk_livros_prateleira" style="width: 40%" value="{{$livro->fk_livros_prateleira}}">
